...
</ol></section><section id="contacts" class="contact"><h2>Contacts</h2><div><div class="links">'''+a('mailto:pietro.califano@polimi.it','pietro.califano@polimi.it')+a('mailto:petercalifano.gs@gmail.com','petercalifano.gs@gmail.com')+a(LINKEDIN,'LinkedIn')+a('assets/pietro-califano-qr.png','Website QR code')+'''</div></div></section>'''
...
research=head('01 / RESEARCH','Research interests','Visual navigation, mapping, and multi-sensor state estimation for spacecraft and robots operating with limited prior knowledge of their surroundings.')
research+='<section id="navigation">'+row('Navigation &amp; mapping','SLAM for small-body exploration','<ul class="research-points"><li>Joint estimation of spacecraft motion and environmental geometry from visual observations.</li><li>Integration of factor-graph smoothing, recursive filtering, and orbital dynamics for proximity navigation.</li><li>Metric-scale observability and uncertainty under target rotation, variable illumination, and uncertain dynamics.</li><li>Computational efficiency and estimation consistency within onboard processing constraints.</li></ul>','PRIMARY RESEARCH',('Visual SLAM','Factor graphs','Recursive filtering','Orbital dynamics'))+'</section>'
research+=row('Multi-sensor estimation','State estimation for robotic platforms','<ul class="research-points"><li>Tightly coupled fusion of visual, inertial, joint-state, and contact measurements.</li><li>Motion estimation for humanoids and rovers with free-floating or underactuated bases.</li><li>Complementary geometric, kinematic, and contact constraints for localization.</li><li>Assessment of sensor contributions, estimation accuracy, and uncertainty.</li></ul>','ROBOTICS',('Sensor fusion','Inertial sensing','Contact measurements','Visual navigation'))
research+=row('Perception','Visual measurements for navigation','<ul class="research-points"><li>Feature tracking and multi-view geometry for motion estimation and scene reconstruction.</li><li>Photometric modelling of visual measurements under variable illumination and viewing geometry.</li><li>Learning-based correction of image-derived navigation measurements, including target centroid estimates.</li><li>Event-based vision for odometry and localization.</li></ul>','VISION &amp; LEARNING',('Computer vision','Photometric modelling','Machine learning','Event-based vision'))
research+='<section id="simulation">'+row('Simulation &amp; validation','Modelling and evaluation of navigation systems','<ul class="research-points"><li>Spacecraft dynamics models with gravity, solar-radiation pressure, and manoeuvres.</li><li>Synthetic sensor measurements for navigation-system development and validation.</li><li>Spectral and radiometric rendering under variable illumination, surface properties, and viewing geometry.</li><li>Monte Carlo assessment of estimation errors, uncertainty, and computational cost.</li></ul>','SIMULATION &amp; VALIDATION',('Dynamical modelling','Sensor simulation','Physically based rendering','Monte Carlo analysis'))+'</section>'
...
projects+=row('RAMSES Farinella','Navigation-filter development','<p class="meta">Project phases: A/B/C (completed); D/E1 (in progress).</p><p>Designed and validated the navigation filter for the RAMSES RCS-1 (Farinella) CubeSat, combining centroiding and LiDAR measurements.</p><p>'+a('https://dart.polimi.it/projects/#_farinella','Farinella at DART')+'</p>','2025–PRESENT',('Navigation filtering','Centroiding','LiDAR'))
projects+=row('FUTURE','Navigation-filter and software integration','<p class="meta">Project phase: C/D/E1.</p><p>Designed and integrated the navigation filter and image-processing interfaces for the ASI FUTURE payload, supporting autonomous navigation from visual observations.</p><p>'+a('https://dart.polimi.it/projects/#_future','FUTURE at DART')+'</p>','2024–PRESENT',('MATLAB / Simulink','C++ services','Jetson Orin NX'))
projects+=row('Hera Milani','GNC software &amp; navigation experiments','<p class="meta">Operations preparation and CNES support.</p><p>Contributed to GNC and image-processing software validation for the Hera Milani CubeSat, including navigation experiments and GNC commissioning.</p><p>'+a('https://dart.polimi.it/projects/#_milani','Milani at DART')+'</p>','2024–PRESENT',('GNC / image processing','Commissioning','Software validation'))
...
about+=row('2023–2027','PhD in Aerospace Engineering','<p>Politecnico di Milano, Department of Aerospace Science and Technology. Doctoral programme started in December 2023.</p>','EXPECTED MARCH 2027')
about+=row('2021–2023','MSc in Space Engineering','<p>Politecnico di Milano. Thesis: Hera mission trajectory-safety assessment through onboard failure detection. Final grade: 110/110.</p>')
...
beyond+='<blockquote class="quote quote-small"><p>“Study hard what interests you the most in the most undisciplined, irreverent and original manner possible.”</p><cite>Richard P. Feynman</cite></blockquote>'
beyond+='<blockquote class="quote quote-small"><p>“Wonder is anywhere, if you are curious enough to discover it.”</p><cite>Personal motto</cite></blockquote><div class="hobby-grid">'
