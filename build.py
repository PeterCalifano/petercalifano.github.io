...
<section class="section"><div class="section-head"><h2>Research &amp; engineering</h2>'''+a('projects.html','Selected projects →')+'''</div><div class="grid">
<article class="feature"><a href="research.html#navigation"><span class="number">01 / RESEARCH</span><h3>Navigation &amp; SLAM</h3><p>Estimating motion and building maps for autonomous exploration of small bodies and poorly known environments.</p></a></article>
<article class="feature"><a href="projects.html#missions"><span class="number">02 / MISSIONS</span><h3>Mission engineering</h3><p>Navigation filters, image-processing interfaces, and GNC software for Farinella, FUTURE, and Hera Milani.</p></a></article>
<article class="feature"><a href="projects.html#software"><span class="number">03 / SOFTWARE</span><h3>Research software</h3><p>Reusable tools for estimation, computer vision, machine learning, and physically based simulation.</p></a></article></div></section>
<div class="callout"><div><h2>Outside work</h2><p>My interests include running, anime, videogames, and learning Japanese.</p></div>'''+a('beyond.html','Beyond work','button')+'''</div><section class="contact"><h2>Contact</h2><div><p>For research enquiries and collaborations, you can reach me by email or LinkedIn.</p><div class="links">'''+a('mailto:pietro.califano@polimi.it','pietro.califano@polimi.it')+a(LINKEDIN,'LinkedIn')+'''</div></div></section>'''
...
research=head('01 / RESEARCH','Research interests','My research focuses on visual navigation and multi-sensor state estimation for spacecraft and robots. Small-body exploration is the main application: limited prior maps, uncertain dynamics, and no GNSS.')
...
research+=row('Multi-sensor estimation','State estimation for robotic platforms','<p>At the DFKI Robotics Innovation Center, I am extending navigation and estimation methods to humanoid and rover platforms with free-floating or underactuated bases.</p><p>The work combines IMU, joint-state, contact, and vision measurements in a tightly coupled estimator, with evaluation on robotic platforms.</p>','ROBOTICS',('Sensor fusion','Contact measurements','Visual navigation'))
...
pubbody=head('02 / PUBLICATIONS','Publications &amp; manuscripts','Selected publications on autonomous navigation and small-body missions, followed by manuscripts with their current status.')
...
projects=head('03 / PROJECTS','Selected projects','Selected contributions to mission software, navigation algorithms, simulation facilities, and research libraries.')
...
projects+=row('FUTURE','Navigation-filter and software integration','<p>Designed, tested, and integrated navigation-filter and image-processing interfaces for the ASI FUTURE payload from phase B through phase D. Connected MATLAB/Simulink prototypes and generated C++ services for NVIDIA Jetson Orin NX deployment.</p><p>'+a('https://dart.polimi.it/projects/','FUTURE at DART')+'</p>','2024–PRESENT',('MATLAB / Simulink','C++ services','Jetson Orin NX'))
...
about=head('04 / BACKGROUND','Background &amp; experience','I am an Aerospace Engineering PhD researcher at DART Lab, Politecnico di Milano, and a guest researcher at the DFKI Robotics Innovation Center. My work combines algorithm design, validation, and software development for navigation systems.')
...
beyond=head('05 / BEYOND WORK','A byte about me.','Outside research, I enjoy running, anime, and videogames. I am also learning Japanese and working on occasional software projects.')
...
for num,title,desc in [('01','Running','I run regularly and enjoy spending time outdoors.'),('02','Anime & videogames','I enjoy watching anime, playing videogames, and discussing both.'),('03','Learning Japanese','I am learning Japanese, getting to grips with the writing systems, pronunciation, and grammar.'),('04','Building things','I also work on computer graphics, ray tracing, and small software tools in my spare time.')]:
...
beyond+='</div><blockquote class="quote"><p>“Give me a task and I will code a SW library to automate it.”</p><cite>My coding motto</cite></blockquote><section class="contact"><h2>Contact</h2><div><div class="links">'+a('mailto:petercalifano.gs@gmail.com','petercalifano.gs@gmail.com')+a('https://t.me/peter_califano','Telegram')+a(LINKEDIN,'LinkedIn')+'</div></div></section>'
...
page('404.html','Page not found','This page could not be found.',head('404 / PAGE NOT FOUND','Page not found','The page may have moved. Head back to the homepage to find research, publications, and projects.')+'<div class="section">'+a(BASE+'/','Back to home','button primary')+'</div>')
