...
<div class="callout"><div><h2>Outside work</h2><p>Running, anime, videogames, and learning Japanese.</p></div>'''+a('beyond.html','Beyond work','button')+'''</div><section class="contact"><h2>Contact</h2><div><p>Research enquiries and collaborations:</p><div class="links">'''+a('mailto:pietro.califano@polimi.it','pietro.califano@polimi.it')+a(LINKEDIN,'LinkedIn')+'''</div></div></section>'''
...
research+=row('Simulation &amp; validation','Navigation models and algorithm evaluation','<p>Built and regression-tested spacecraft-navigation models covering gravity, solar-radiation pressure, and finite burns, including checks for agreement between source models and generated code.</p><p>Developed a C++20 CUDA/OptiX renderer for spectral and radiometric image simulation, with BRDF models and robotics interfaces.</p>','RESEARCH INFRASTRUCTURE',('Monte Carlo analysis','CUDA / OptiX','Sensor simulation'))
...
('OPEN SOURCE','slam-primitives','Reusable primitives for visual navigation and SLAM.',['Computer vision','SLAM'],GH+'/slam-primitives','View repository'),
...
('OPEN SOURCE','torchAutoForge-deploy','Tools for deploying trained models in inference applications.',['Inference','Deployment'],GH+'/torchAutoForge-deploy','View repository'),
...
about=head('04 / BACKGROUND','Background &amp; experience','Pietro Califano is a PhD researcher in Aerospace Engineering at DART Lab, Politecnico di Milano, and a guest researcher at the DFKI Robotics Innovation Center. His research concerns visual navigation and state estimation for spacecraft and robots.')
