...
cards=[
('NAVIGATION','Small-body SLAM stack','Monocular SLAM and orbital-dynamics-based filtering for spacecraft navigation and mapping during small-body proximity operations.',['C++20','GTSAM','MATLAB'],'research.html#navigation','Research overview'),
...
('SIMULATION','Spectral & radiometric renderer','Spectral and radiometric rendering for synthetic navigation imagery and sensor simulation.',['C++20','CUDA / OptiX','Radiometry'],'research.html#simulation','Research overview'),
